...
Uploads the photo from the `file` query param to an AWS S3 buckets and creates a photo resource in the database for the current user or the current user's dog. Requires a PhotoInputType argument. Returns a PhotoType object.
